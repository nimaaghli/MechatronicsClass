...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_untitled               RT_MODEL_untitled_T
...
typedef struct {
  real_T DiscreteFIRFilter_states;     /* '<Root>/Discrete FIR Filter' */
  real_T PCI6024EDA_RWORK[6];          /* '<Root>/PCI-6024E DA' */
  real_T PCI6024EAD_RWORK[64];         /* '<Root>/PCI-6024E AD' */
  struct {
    void *LoggedData;
  } Scope_PWORK;                       /* '<Root>/Scope' */

  int_T PCI6024EDA_IWORK[2];           /* '<Root>/PCI-6024E DA' */
...
struct P_untitled_T_ {
  ...
  real_T SignalGenerator_Frequency;    /* Computed Parameter: SignalGenerator_Frequency
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
  real_T PCI6024EDA_P1_Size[2];        /* Computed Parameter: PCI6024EDA_P1_Size
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P1;                /* Expression: channel
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P2_Size[2];        /* Computed Parameter: PCI6024EDA_P2_Size
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P2;                /* Expression: range
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P3_Size[2];        /* Computed Parameter: PCI6024EDA_P3_Size
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P3;                /* Expression: reset
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P4_Size[2];        /* Computed Parameter: PCI6024EDA_P4_Size
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P4;                /* Expression: initValue
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P5_Size[2];        /* Computed Parameter: PCI6024EDA_P5_Size
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P5;                /* Expression: sampletime
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P6_Size[2];        /* Computed Parameter: PCI6024EDA_P6_Size
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P6;                /* Expression: slot
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P7_Size[2];        /* Computed Parameter: PCI6024EDA_P7_Size
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  real_T PCI6024EDA_P7;                /* Expression: boardType
                                        * Referenced by: '<Root>/PCI-6024E DA'
                                        */
  ...
  real_T DiscreteFIRFilter_InitialStates;/* Expression: 0
                                          ...
                                          */
  real_T DiscreteFIRFilter_Coefficients[2];/* Expression: [0.5 0.5]
                                            * Referenced by: '<Root>/Discrete FIR Filter'
                                            */
};
...
extern void untitled_output(int_T tid);
extern void untitled_update(int_T tid);
 ...
 *
 * '<Root>' : 'untitled'
 * '<S1>'   : 'untitled/Async Rate Transition '
 * '<S2>'   : 'untitled/Scope '
 */
