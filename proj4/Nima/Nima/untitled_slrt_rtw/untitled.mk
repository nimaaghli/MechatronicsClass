...
MODEL           = untitled
MODULES         = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c untitled_capi.c untitled_data.c xpc_datatype_ground.c 
...
S_FUNCTIONS     = danipcie.c adnipcie.c xpcionie.c
S_FUNCTIONS_LIB = 
NUMST           = 3
TID01EQ         = 1
NCSTATES        = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\untitled_slrt_rtw
