...
MODEL           = speed2
MODULES         = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c rtw_modelmap_utils.c speed2_capi.c speed2_data.c xpc_datatype_ground.c 
MAKEFILE        = speed2.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\Lab322\Documents\MATLAB\Nima
S_FUNCTIONS     = donipcie.c dinipcie.c adnipcie.c xpcionie.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 0
NCSTATES        = 0
BUILDARGS       =  EXT_MODE=1
MULTITASKING    = 1
EXT_MODE        = 0
MEX_OPT_FILE    = -f 
...
MODELLIB                  = speed2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = speed2_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\speed2_slrt_rtw
